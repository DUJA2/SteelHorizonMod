...
@Mod(Steelhorizon.MODID)
public class Steelhorizon {
    ...
    public Steelhorizon(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (Steelhorizon) to respond directly to events.
